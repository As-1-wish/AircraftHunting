...
class Track(models.Model):
    ...
    coorX = models.DecimalField(max_digits=4, decimal_places=3)  # x坐标
    coorY = models.DecimalField(max_digits=4, decimal_places=3)  # y坐标
    speed = models.DecimalField(max_digits=3, decimal_places=3)  # 速度

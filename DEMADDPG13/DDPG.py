...
class DDPG:
    ...
    def save_model(self, a_fn):
        self.actor1.save("./model/ddpg_actor{}_episode{}.h5".format(1, a_fn))
        self.actor2.save("./model/ddpg_actor{}_episode{}.h5".format(2, a_fn))
        self.actor3.save("./model/ddpg_actor{}_episode{}.h5".format(3, a_fn))
        self.critic1.save("./model/ddpg_critic{}_episode{}.h5".format(1, a_fn))
        self.critic2.save("./model/ddpg_critic{}_episode{}.h5".format(2, a_fn))
        self.critic3.save("./model/ddpg_critic{}_episode{}.h5".format(3, a_fn))

    def load_actor(self, a_fn):
        self.actor1.load_weights("./model/ddpg_actor{}_episode{}.h5".format(1, a_fn))
        self.actor_target1.load_weights("./model/ddpg_actor{}_episode{}.h5".format(1, a_fn))
        self.actor2.load_weights("./model/ddpg_actor{}_episode{}.h5".format(2, a_fn))
        self.actor_target2.load_weights("./model/ddpg_actor{}_episode{}.h5".format(2, a_fn))
        self.actor3.load_weights("./model/ddpg_actor{}_episode{}.h5".format(3, a_fn))
        self.actor_target3.load_weights("./model/ddpg_actor{}_episode{}.h5".format(3, a_fn))
        print(self.actor1.summary())
        print(self.actor2.summary())
        print(self.actor3.summary())

    def load_critic(self, a_fn):
        self.critic1.load_weights("./model/ddpg_critic{}_episode{}.h5".format(1, a_fn))
        self.critic_target1.load_weights("./model/ddpg_critic{}_episode{}.h5".format(1, a_fn))
        self.critic2.load_weights("./model/ddpg_critic{}_episode{}.h5".format(2, a_fn))
        self.critic_target2.load_weights("./model/ddpg_critic{}_episode{}.h5".format(2, a_fn))
        self.critic3.load_weights("./model/ddpg_critic{}_episode{}.h5".format(3, a_fn))
        self.critic_target3.load_weights("./model/ddpg_critic{}_episode{}.h5".format(3, a_fn))
    ...
    def train(self, max_episodes=EPISODE, max_epochs=8000, max_steps=500, save_freq=50):
        ...
        done, episode, steps, epoch, total_reward = False, 1001, 0, 0, 0
...
if __name__ == "__main__":
    ...
    env = UAV()
    ddpg = DDPG(env)
    ddpg.load_critic(1000)
    ddpg.load_actor(1000)
    plot_r = []
    plot_r2 = []
